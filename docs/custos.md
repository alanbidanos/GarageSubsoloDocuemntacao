...
A seguir, é apresentada uma estimativa inicial dos custos envolvidos no desenvolvimento e operação do sistema de gestão Garage Subsolo. Os valores são aproximados e refletem custos típicos de infraestrutura, mão de obra e manutenção para projetos de porte semelhante.

## 9.1 Custos de Desenvolvimento
Estes são os custos relacionados à criação e implementação do sistema.
...
**Subtotal Desenvolvimento:** **R$ 11.000,00**

---

## 9.2 Custos de Infraestrutura
Custos estimados para manter o sistema em funcionamento.
...
## 9.4 Custo Total do Projeto

| Categoria | Custo |
|----------|-------|
| Desenvolvimento (único) | R$ 11.000,00 |
